...
const Cart = () => {
  ...
  return (
    <div className='border-t pt-14'>
          ...
          cartData.map((item, index) => {
            ...
            return (
              <div key={index} className=' py-4 border-t border-gray-200 border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center  gap-4 '>
                ...
                <input onChange={(e) => e.target.value === ' ' || e.target.value === '0' ? null : updateQuantity(item._id, item.size, Number(e.target.value))} className=' border h-9 border-gray-300 sm:max-w-20 px-2 py-1' type="number" min={1} defaultValue={item.quantity} />
      ...
      <div className='flex justify-end my-29'>
